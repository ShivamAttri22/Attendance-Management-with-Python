...
res=0
exists = os.path.isfile("E:\\Projects\\Face_recognition_based_attendance_system\\StudentDetails\\StudentDetails.csv")
if exists:
    with open("E:\\Projects\\Face_recognition_based_attendance_system\\StudentDetails\\StudentDetails.csv", 'r') as csvFile1:
        reader1 = csv.reader(csvFile1)
        for l in reader1:
            res = res + 1
    res = (res // 2) - 1
